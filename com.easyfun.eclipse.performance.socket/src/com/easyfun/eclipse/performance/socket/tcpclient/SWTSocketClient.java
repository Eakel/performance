...
/**
 * @author linzhaoming Create Date: 2010-12-13
 */
public class SWTSocketClient extends ItemComposite {
	...
	public SWTSocketClient(Composite parent, int style, Item item) {
