 ...
 */
public class JNDISetttingsDialog extends Dialog {

	public JNDISetttingsDialog(Shell shell) {
		super(shell);
	}
	...
	protected void configureShell(Shell newShell) {
		...
		newShell.setText("JNDI Settings");
	}
	...
	protected Control createDialogArea(Composite parent) {
		...
		refreshButton.setText("Refresh the JNDI Tree");
