 ...
 */
public class SWTSocketServer extends ItemComposite {
	...
	public SWTSocketServer(Composite parent, int style, Item item) {
	...
	private void connect() {
		...
		BusyIndicator.showWhile(getDisplay(), new Runnable() {
			public void run() {
				...
				append("> ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~");
				socketServer = SocketServer.handle(SWTSocketServer.this, server);
			}
		});
	}
