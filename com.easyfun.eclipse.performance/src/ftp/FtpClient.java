...
public class FtpClient{
	...
	public static void main(String[] args) throws Exception{
		...
		LogHelper.info(null,"connect: " + (t2 - t1));
		boolean isAuthenticated = conn.authenticateWithPassword(username, password);		
		long t3 = System.currentTimeMillis();
		LogHelper.info(null,"Auth: " + (t3 - t2));
		...
		LogHelper.info(null,"SFTP: " + (t4 - t3));
		LogHelper.info(null,client.canonicalPath(""));
		long t5 = System.currentTimeMillis();
		LogHelper.info(null,"t5: " + (t5 - t4));
		Vector ve = client.ls("/home/linzm");
		long t6 = System.currentTimeMillis();
		LogHelper.info(null,"t6: " + (t6 - t5));
		for (Object object : ve) {
			LogHelper.info(null,object.toString());
		}
