package com.easyfun.eclipse.performance.appframe.monitor.mon.service.interfaces;
...
public interface IMonSV {
	 ...
	 * <li>[MON_W_PERSON]
	 * */
	public String[] getPhonenumByInfoId(long paramLong) throws Exception;
	...
	public MonDbUrl getMonDbUrlByUrlName(String paramString) throws Exception;
